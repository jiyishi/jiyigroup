...
typedef enum : NSUInteger {
    JYRegisterViewTypeNoNav,   // 登录界面(没导航条)
    JYRegisterViewTypeNav,     // 登录界面(有导航条)
} JYRegisterViewType;

typedef enum : NSUInteger {
    JYRegisterViewTypeScanfPhoneSMS, // 输入手机号 获取验证码
    JYRegisterViewTypeNoScanfSMS,    // 找回密码 ()
} JYRegisterViewTypeSMS;
...
- (instancetype )initwithFrame:(CGRect)frame
            JYRegisterViewType:(JYRegisterViewType)JYRegisterViewType      //类型
...
- (instancetype )initwithFrame:(CGRect)frame
         JYRegisterViewTypeSMS:(JYRegisterViewTypeSMS)JYRegisterViewTypeSMS //类型
